...
F2C1 <- fx_traits_vs_biomass("F2C1",troll,1,meta,g_by,"dmax","wsg",lab2,lab3)
F2C2 <- fx_traits_vs_biomass("F2C2",troll,1,iso,g_by,"dmax","wsg",lab2,lab3)
F2C3 <- fx_traits_vs_biomass("F2C3",troll,32,meta,g_by,"lma","dmax",lab1,lab2)
F2C4 <- fx_traits_vs_biomass("F2C4",troll,32,iso,g_by,"pmass","lma",lab4,lab1)
...
F2C1 <- fx_traits_vs_biomass("F2C1_hrm",troll,1,meta,g_by,"h_realmax","wsg",lab2,lab3)
F2C2 <- fx_traits_vs_biomass("F2C2_hrm",troll,1,iso,g_by,"h_realmax","wsg",lab2,lab3)
F2C3 <- fx_traits_vs_biomass("F2C3_hrm",troll,32,meta,g_by,"lma","h_realmax",lab1,lab2)
F2C4 <- fx_traits_vs_biomass("F2C4_hrm",troll,32,iso,g_by,"pmass","lma",lab4,lab1)
