...
lab3<-"Monoculture \nbiomass"
lab4<-"Mixture biomass"

#G1C1_a <- fx_traits_vs_biomass_jitter(plotName="G1C1_a",model=adam,NoSpp=1,stage=meta,trait1="abmi",trait2="no3i",xlab="Monoculture biomass",ylab=lab1)
#G1C2_a <- fx_traits_vs_biomass_jitter("G1C2_a",adam,1,iso,"abmi","no3i","abmi",lab1)
#G1C3_a <- fx_traits_vs_biomass_jitter("G1C3_a",adam,32,meta,"abmi","no3i","abmi",lab1)
#G1C4_a <- fx_traits_vs_biomass_jitter("G1C4_a",adam,32,iso,"abmi","no3i","abmi",lab1)
#G1C1_b <- fx_traits_vs_biomass_jitter("G1C1_b",adam,1,meta,"abmi","pNi","abmi",lab2)
#G1C2_b <- fx_traits_vs_biomass_jitter("G1C2_b",adam,1,iso,"abmi","pNi","abmi",lab2)
#G1C3_b <- fx_traits_vs_biomass_jitter("G1C3_b",adam,32,meta,"abmi","pNi","abmi",lab2)
#G1C4_b <- fx_traits_vs_biomass_jitter("G1C4_b",adam,32,iso,"abmi","pNi","abmi",lab2)
#abmi2 <- fx_traits_vs_biomass_jitter("abmi2",adam,1,meta,g_by,"abmi","pNi","abmi",lab2)

G1C1 <- fx_traits_vs_biomass_jitter("G1C1",adam,1,meta,"no3i","abmi",lab1,lab3)
G1C2 <- fx_traits_vs_biomass_jitter("G1C2",adam,1,meta,"no3i","Biomass",lab1,lab4)
G1C3 <- fx_traits_vs_biomass_jitter("G1C3",adam,32,meta,"no3i","abmi",lab2,lab3)
G1C4 <- fx_traits_vs_biomass_jitter("G1C4",adam,32,meta,"no3i","Biomass",lab2,lab4)
...
G2C1 <- fx_traits_vs_biomass_jitter("G2C1",lindsay,1,meta,"Vi","Biomass",lab1,lab3)
G2C2 <- fx_traits_vs_biomass_jitter("G2C2",lindsay,1,meta,"thetai","Biomass", lab2,lab3)
G2C3 <- fx_traits_vs_biomass_jitter("G2C3",lindsay,32,meta,"Vi","Biomass",lab1,lab4)
G2C4 <- fx_traits_vs_biomass_jitter("G2C4",lindsay,32,iso,"thetai","Biomass",lab2,lab4)
#
#### Grass3 (IBC-grass)
