...
lab1 <- "monoculture aboveground biomass" #"no3i (nitrogen R*)"
lab2 <- "r_pNi (reciprocal of \n aboveground N concentration)"
...
lab1 <- "PC1score associated with LMR \n (leaf to mass ratio)"
lab2 <- "PC2score associated with Gmax \n (maximum resource utilization) \n and MaxMass (Plant's maximum size)"
lab3 <- "PC3score associated with SLA and MeanSpacerLength"
...
lab1 <- "PC1score associated with \n LMA, nmass, and pmass"
lab2 <- "PC2score associated with \n h_realmax = hmax * dmax / (dmax + ah)"
lab3 <- "PC3score associated with \n wsg (wood specific gravity)"
