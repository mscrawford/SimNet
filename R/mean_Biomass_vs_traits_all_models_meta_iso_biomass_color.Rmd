...
t1_vs_t2_vs_biomass_meta_iso <- function(model,NoSpp,g_by,Biomass,trait1,trait2,xlab,ylab){
...
p1 <- t1_vs_t2_vs_biomass_meta_iso(adam,1,g_by,"Biomass","pNi","no3i",lab1,lab2)
ggsave("G1mono.pdf")
p2 <- t1_vs_t2_vs_biomass_meta_iso(adam,1,g_by,"Biomass","no3i","pNi",lab2,lab1)
p1m <- t1_vs_t2_vs_biomass_meta_iso(adam,32,g_by,"Biomass","pNi","no3i",lab1,lab2)
ggsave("G1mix.pdf")
p2m <- t1_vs_t2_vs_biomass_meta_iso(adam,32,g_by,"Biomass","no3i","pNi",lab2,lab1)
...
p3 <- t1_vs_t2_vs_biomass_meta_iso(lindsay,1,g_by,"Biomass","Vi","thetai",lab1,lab2)
ggsave("G2mono.pdf")
p4 <- t1_vs_t2_vs_biomass_meta_iso(lindsay,1,g_by,"Biomass","thetai","Vi",lab2,lab1)
p3m <- t1_vs_t2_vs_biomass_meta_iso(lindsay,32,g_by,"Biomass","Vi","thetai",lab1,lab2)
ggsave("G2mix.pdf")
p4m <- t1_vs_t2_vs_biomass_meta_iso(lindsay,32,g_by,"Biomass","thetai","Vi",lab2,lab1)
...
p5 <- t1_vs_t2_vs_biomass_meta_iso(IBC_grass,1,g_by,"Biomass","Gmax.x","MaxMass.x",lab1,lab2)
ggsave("G3mono.pdf")
p6 <- t1_vs_t2_vs_biomass_meta_iso(IBC_grass,1,g_by,"Biomass","LMR.x","Gmax.x",lab3,lab1)
p5m <- t1_vs_t2_vs_biomass_meta_iso(IBC_grass,32,g_by,"Biomass","Gmax.x","MaxMass.x",lab1,lab2)
ggsave("G3mix.pdf")
p6m <- t1_vs_t2_vs_biomass_meta_iso(IBC_grass,32,g_by,"Biomass","LMR.x","Gmax.x",lab3,lab1)

ggarrange(p5, p5m, ncol = 2, nrow = 1)
```
...
p7 <- t1_vs_t2_vs_biomass_meta_iso(PPA,1,g_by,"Biomass","PC1score","PC2score",lab1,lab2)
ggsave("F1mono.pdf")
p8 <- t1_vs_t2_vs_biomass_meta_iso(PPA,1,g_by,"Biomass","PC2score","PC1score",lab2,lab1)
p7m <- t1_vs_t2_vs_biomass_meta_iso(PPA,32,g_by,"Biomass","PC1score","PC2score",lab1,lab2)
ggsave("F1mix.pdf")
p8m <- t1_vs_t2_vs_biomass_meta_iso(PPA,32,g_by,"Biomass","PC2score","PC1score",lab2,lab1)
```
...
p9 <- t1_vs_t2_vs_biomass_meta_iso(troll,1,g_by,"Biomass","lma","dmax",lab1,lab2)
p10 <- t1_vs_t2_vs_biomass_meta_iso(troll,1,g_by,"Biomass","dmax","wsg",lab2,lab3)
ggsave("F2mono.pdf")
p11 <- t1_vs_t2_vs_biomass_meta_iso(troll,1,g_by,"Biomass","wsg","dmax",lab3,lab2)
p9m <- t1_vs_t2_vs_biomass_meta_iso(troll,32,g_by,"Biomass","lma","dmax",lab1,lab2)
ggsave("F2mix.pdf")
p10m <- t1_vs_t2_vs_biomass_meta_iso(troll,32,g_by,"Biomass","dmax","wsg",lab2,lab1)
p11m <- t1_vs_t2_vs_biomass_meta_iso(troll,32,g_by,"Biomass","wsg","dmax",lab3,lab2)
```
...
g_by <- c("SpeciesID", "Year","Stage", "maxSize.x", "pLeaf.x", "pRoot.x", "pStorage.x")
...
p12 <- t1_vs_t2_vs_biomass_meta_iso(bjoern,1,g_by,"Biomass","maxSize.x","pLeaf.x",lab1,lab2)
p13 <- t1_vs_t2_vs_biomass_meta_iso(bjoern,1,g_by,"Biomass","maxSize.x","pStorage.x",lab1,lab3)
ggsave("Dmono.pdf")
p12m <- t1_vs_t2_vs_biomass_meta_iso(bjoern,32,g_by,"Biomass","maxSize.x","pLeaf.x",lab1,lab2)
ggsave("Dmix.pdf")
p13m <- t1_vs_t2_vs_biomass_meta_iso(bjoern,32,g_by,"Biomass","maxSize.x","pStorage.x",lab1,lab3)
```
## All models
...
ggarrange(p1,p1m, p3,p3m, p5,p5m, p7,p7m, p10,p9m, p13,p12m, 
