...
p5 <- t1_vs_t2_vs_biomass_meta_iso("G3mono",IBC_grass,1,g_by,"Biomass","Gmax.x","MaxMass.x",lab1,lab2)
p6 <- t1_vs_t2_vs_biomass_meta_iso("G3mix",IBC_grass,32,g_by,"Biomass","Gmax.x","MaxMass.x",lab1,lab2)
```
...
p11 <- t1_vs_t2_vs_biomass_meta_iso("Dmono",bjoern,1,g_by,"Biomass","maxSize.x","pStorage.x",lab1,lab3)
p12 <- t1_vs_t2_vs_biomass_meta_iso("Dmix",bjoern,32,g_by,"Biomass","maxSize.x","pLeaf.x",lab1,lab2)
```
## All models
