...
```
This document describes PPA, using **Richness** as the focal biodiversity metric.
...
cowplot::save_plot(p, filename = "~/Desktop/Richness.pdf", ncol = 2, base_asp = 1.1)
