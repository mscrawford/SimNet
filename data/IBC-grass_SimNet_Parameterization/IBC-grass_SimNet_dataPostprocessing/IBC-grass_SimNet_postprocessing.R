...
data.dir = "/Users/Theodore/Documents/Dropbox/Work/Projects/SimNet/Modelling_Experiment/scripts/IBC-grass-SimNet_Parameterization/IBC-grass_SimNet_dataPreprocessing/data/data/out"
...
save(d, file = "~/Desktop/IBC-grass_Table1.rda")
write_csv(traits, path = "~/Desktop/IBC-grass_Table2.csv")
