...
sardinilla2_mono$mName <- rep("Sardinilla >2012",times=dim(sardinilla2_mono)[1])
sardinilla2_mix$mName <- rep("Sardinilla >2012",times=dim(sardinilla2_mix)[1])
...
all_d <- rbind(cedar_2t_mono, cedar_2t_mix, jena_Fons_mix_2t, jena_Fons_mono_2t, sardinilla_mono, sardinilla_mix, sardinilla2_mono, sardinilla2_mix)
